  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="card">
          <img src="urunler/elbiseler/giyim1/foto1.jpg" class="card-img-top" alt="Ürün 1">
          <div class="card-body">
            <h5 class="card-title">Ürün 1</h5>
            <p class="card-text">Fiyat: 699TL</p>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="card">
          <img src="urunler/elbiseler/giyim2/foto1.jpg" class="card-img-top" alt="Ürün 2">
          <div class="card-body">
      ...
      <div class="col-lg-4 col-md-6">
        <div class="card">
          <img src="urunler/elbiseler/giyim3/foto1.jpg" class="card-img-top" alt="Ürün 3">
          <div class="card-body">
            <h5 class="card-title">Ürün 3</h5>
            <p class="card-text">Fiyat: 1099TL</p>
            <a href="#" class="btn btn-primary sepete-ekle">Sepete Ekle</a>
          </div>
        </div>
      </div>
